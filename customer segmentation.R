#In the first step of this project, we will perform data exploration.
...
#and use the summary() function to output summary of it.
...
#In this, we will create a barplot and a piechart 
#to show the gender distribution across our customer_data dataset.
...
boxplot(customer_data$Age,col="red",
...
hist(customer_data$Annual.Income..k.., col="yellow",
...
# In the Kernel Density Plot that we displayed above,
# we observe that the annual income has a normal distribution.
...
# We can see Descriptive Analysis of Spending Score is that Min is 1, Max is 99 
# and avg. is 50.20. 
# From the histogram, we conclude that customers between class 40 and 50 
# have the highest spending score among all the classes.
...
#Now, we make use of the fviz_nbclust() function 
# to determine and visualize the optimal number of clusters as follows 
...
# Cluster 6 and 4 - These clusters represent the customer_data with the medium 
   #income salary as well as the medium annual spend of salary
#Cluster 1 - This cluster represents the customer_data having a high annual income
    # as well as a high annual spend.
#Cluster 3 - This cluster denotes the customer_data with low annual income 
    # as well as low yearly spend of income.
